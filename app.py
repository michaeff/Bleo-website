...
def download_week(week):
    url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/czi_images/week{week}.czi"
    return redirect(url)

@app.route('/download/weektif<int:week>')
def download_weektif(week):
    url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/czi_images/week{week}.tif"
    return redirect(url)
...
def download_detailweek(week):
    ...
    week0= week[0]
    if week0 == '0':
        url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/czi_images_detailed/week{week}/week{week}copy.czi"
        return redirect(url)
    elif week0=="o":
        url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/overview/{week[8:]}/over.czi"
        return redirect(url)
    else:
        weekrest= week[1:]
        url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/czi_images_detailed/week{week0}/{weekrest}/week{week0}_{weekrest}.czi"
        return redirect(url)
    # # Path to the CZI file
    # week0= week[0]
    # if week0 == '0':
...
def download_detailweektif(week):
    ...
    week0= week[0]
    if week0 == '0':
        url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/czi_images_detailed/week{week}/week{week}.tif"
        return redirect(url)
    elif week0=="o":
        url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/overview/{week[8:]}/overview.tif"
        return redirect(url)
    else:
        weekrest= week[1:]
        url = f"https://bleo-bucket.sfo3.digitaloceanspaces.com/static/czi_images_detailed/week{week0}/{weekrest}/week{week0}_{weekrest}.tif"
        return redirect(url)
